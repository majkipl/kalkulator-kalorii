...
// ZMIANA START: Import biblioteki Tippy.js
import Tippy from '@tippyjs/react';
import 'tippy.js/dist/tippy.css'; // Domyślne style
import 'tippy.js/animations/scale-subtle.css'; // Opcjonalna animacja
// ZMIANA KONIEC
    ...
    return (
        <div className="bg-gray-100 dark:bg-gray-900 min-h-screen font-sans">
            ...
            <main className="container mx-auto p-4 flex flex-col lg:grid lg:grid-cols-3 gap-6">
                ...
                {/* --- Kolumna prawa (na desktopie) / Pierwsza w kolejności (na mobilce) --- */}
                <div className="order-1 lg:order-2 lg:col-span-2 flex flex-col gap-6">

                    {/* Dziennik Posiłków: 1. na mobilce */}
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
...
const AddMealForm = ({ foods, onSave, onCancel, isEditMode, initialData, theme }) => {
    ...
    // ZMIANA START: Użycie Tippy w CustomOption
    ...
    // ZMIANA START: Użycie Tippy w CustomSingleValue
...
const FoodManagementModal = ({ foods, user, hiddenFoodIds, onToggleHide, onCancel, onEdit, onDelete }) => {
    ...
    // ZMIANA START: Wrapper Tippy dla obrazka
                            ...
                            return (
                                <div key={food.id} className="flex items-center justify-between bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                                    <div className="flex items-center gap-3">
                                        {/* ZMIANA START: Użycie nowego komponentu z tooltipem */}
