...
const VetVisitFormModal = ({onSave, onCancel, initialData}) => {
    ...
    const processSubmit = (data) => {
        onSave({...data, date: new Date(data.date)});
    };
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-2xl w-full max-w-lg animate-fade-in-up">
                <form onSubmit={handleSubmit(processSubmit)} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" {...register("reason")} className={formStyles.input} ref={firstInputRef}
